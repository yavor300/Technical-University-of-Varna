...
* Задача 6
*
* Съставете програма с функция за изчисляване разликата от елементите на масив от реални числа.
...
double caclulateDiff(double arr[], int length);
...
int main()
{
	...
	cout << caclulateDiff(numbers, lenght);
}
