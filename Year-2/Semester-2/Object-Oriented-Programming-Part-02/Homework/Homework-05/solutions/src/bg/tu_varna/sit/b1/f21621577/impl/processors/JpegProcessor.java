...
public class JpegProcessor extends ImageProcessor {
  ...
  public JpegProcessor(String filename) throws IOException {
    super(filename);
  }
  ...
  private String readJpeg() throws IOException {
  ...
  private void writeJpeg(String content) throws IOException {
