...
INT_PTR CALLBACK	ComboBox(HWND, UINT, WPARAM, LPARAM);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDM_ABOUT:
			...
			break;
		case ID_D_D3:
			DialogBox(hInst, MAKEINTRESOURCE(IDD_DIALOG1), hWnd, ComboBox);
			break;
		case IDM_EXIT:
			DestroyWindow(hWnd);
			break;
...
INT_PTR CALLBACK ComboBox(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	char data[20];
	int c_index, l_index;
	int mID;
